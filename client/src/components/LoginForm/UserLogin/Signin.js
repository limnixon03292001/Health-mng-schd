  ...
  return (
    <div className="lg:px-8">
      <h3 className="mb-6 text-2xl text-center">
        Acacia Health Center Scheduling system
      </h3>
      ...
      <div className="text-center">
        <span className="cursor-pointer inline-block text-sm text-blue-500 align-baseline hover:text-blue-800" onClick={() => setisSwitch(true)}>
          Create an Account!
        </span>
      </div>
    </div>
